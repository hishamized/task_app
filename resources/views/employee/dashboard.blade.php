        ...
        <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
            <div class="position-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="#section1">Assigned Task</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section2">My Projects</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section3">Important Tasks</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section4">Update Tasks</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section5">Apply Leave</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section6">View Leave Status</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#section7">Employees Rewards and Scores</a>
                    </li>
                </ul>
            </div>
        </nav>
